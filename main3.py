...
# List of image paths
image_paths = ['test1.jpg', 'test2.jpg', 'test3.jpg',"test4.jpg"]  # Replace with paths to your images
...
for image_path in image_paths:
    ...
    if image is not None:
        ...
        if predicted_emotion == 'neutral':
            print(f"Predicted Emotion for {image_path}: Neutral")
        else:
            print(f"Predicted Emotion for {image_path}: {predicted_emotion}, Probability: {max_probability:.2f}")
    else:
